...
class FoodAdapter (private var foodList: ArrayList<FoodModel>) : RecyclerView.Adapter<FoodAdapter.ViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.calories_tracker_food_list, parent, false)
